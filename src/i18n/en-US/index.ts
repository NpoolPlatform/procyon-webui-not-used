...
export default {
  ...
  MSG_GET_COINS_FAIL: 'Cannot get coins',

  MSG_SPACEMESH_MINING: 'Spacemesh Mining',
  MSG_SPACEMESH: 'Spacemesh',
  ...
  MSG_ADD_MOBILE_NUMBER: 'ADD MOBILE NUMBER',
  MSG_ADD_MOBILE_NUMBER_TIPS: 'Please add your mobile number to ensure the security of your account. You can use your phone number to recover your account in case you cannot access your email.',
  MSG_SETUP_MOBILE_NUMBER: 'Setup Mobile Number',
  MSG_SETUP_LATER: 'Setup Later',
  MSG_SETUP_KYC: 'SETUP KYC',
  MSG_SETUP_KYC_TIPS: 'Enter your personal information (KYC) to ensure the security of your account. Certain features are locked until KYC is approved.',
  MSG_PROCEED_TO_KYC_SETUP: 'Proceed to KYC Setup',
  MSG_SETUP_GOOGLE_AUTHENTICATOR: 'Setup Google Authenticator',
  ...
  MSG_ORDER_PAY_LATER: 'You can access this order again from your dashboard to complete the payment within the alloted time.',
  MSG_ORDER_PENDING: 'ORDER PENDING',
  MSG_PENDING: 'Pending',
  MSG_ORDER_PAYMENT_AWAITING: 'We are awaiting the arrival of your payment. It may take up to 10 minutes. You can review this order on your dashboard.',

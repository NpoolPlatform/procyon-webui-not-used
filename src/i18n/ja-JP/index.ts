...
export default {
  MSG_GET_APP_LANG_INFOS_FAIL: 'アプリの言語情報が取得できない',
  MSG_SEND_CODE: '送信コード',
  MSG_GET_APP_USER_INFO_FAIL: 'アプリのユーザー情報を取得できない',
  MSG_GET_MY_INVITATIONS_FAIL: '招待状が届かない',
  MSG_SETUP_GOOGLE_AUTHENTICATION_FAIL: 'google認証が設定できない',
  ...
  MSG_LABEL: '登録名',
  MSG_ADD_MOBILE_NUMBER: '電話番号を登録',
  MSG_ADD_MOBILE_NUMBER_TIPS: 'アカウント保護のため、電話番号の登録を行いましょう。メールアドレスを忘れた、もしくはメールにログインができない場合、電話番号を使いProcyonアカウントを復元することができます。',
  MSG_SETUP_MOBILE_NUMBER: '電話番号の設定へ進む',
  MSG_SETUP_LATER: '後で設定',
  MSG_SETUP_KYC: 'KYCの設定',
  MSG_SETUP_KYC_TIPS: 'アカウント保護のため、個人情報を登録してKYC (本人確認) を行いましょう。',
  MSG_PROCEED_TO_KYC_SETUP: 'KYCの設定へ進む',
  MSG_SETUP_GOOGLE_AUTHENTICATOR: 'Google認証の設定',
  ...
  MSG_NOT_PAID: '未払い',
  MSG_ORDER_PAY_LATER: '注文は、ダッシュボードの「注文履歴」からご確認いただけます。',
  MSG_ORDER_PENDING: '注文着金待ち',
  MSG_PENDING: '着金待ち',
  MSG_ORDER_PAYMENT_AWAITING: 'お客様からの着金確認を行っております。ネットワークの状況次第で、着金まで10分かかる場合もございますので、あらかじめご了承ください。',

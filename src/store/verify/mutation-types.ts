export enum MutationTypes {
  SetLoginEmailVerifyDialog = 'VERIFY_SET_LOGIN_EMAIL_VERIFY_DIALOG',
  SetLoginGoogleAuthenticationVerifyDialog = 'VERIFY_SET_LOGIN_GOOGLE_AUTHENTICATION_VERIFY_DIALOG',
